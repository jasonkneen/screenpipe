...
connections give pipes and AI agents structured context from the source system, not just OCR of whatever was visible on screen.

<img src="/app-screenshots/settings-privacy.png" alt="screenpipe privacy settings" />
