...
<img src="/app-screenshots/settings-recording.png" alt="screenpipe recording settings" />
...
| summary missed context | choose a custom pipe that also searches OCR frames during the meeting window |
